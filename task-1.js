...
let user = [
    { name: "Aufa", age: 20, major: "Informatics" },
    { name: "Isfhani Ghiyath", age: 21, major: "Information System" },
    { name: "Fai", age: 22, major: "Digital Business" },
    { name: "Agung", age: 20, major: "Informatics" },
    { name: "Sabiq", age: 22, major: "Informatics"},
];
